...
public class GroupedProperties {
    ...
    private Hashtable<String, Properties> groups= null;
	...
	groups= new Hashtable<String, Properties>();
    }
     ...
     * GroupedProperties.
     */
    public Enumeration<String> groupNames() {
        return groups.keys();
    }
    ...
    public Enumeration<?> propertyNames(String groupName) {
        if (groups.containsKey(groupName)) {
            return groups.get(groupName).propertyNames();
        } else {
	...
	Properties props = groups.get(group);

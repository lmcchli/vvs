...
## ntf_ct_4001037.sh --
##
##. 4001037	SMS	Sourceaddress 	voice
##. 
##.    Verify that ntf can have different sourceaddresses per type. 
##. 
##.    Action: Set sourceaddress_voice to ""0,0,voice"" in
##.    notification.cfg. Restart ntf. Send an voice message that will get
##.    an notification.
##. 
...
ssh $ntf_host "echo sourceaddress_voice=0,0,voice >> $ntfcfg"
...
grep "^From: 0,0,voice" $smslog > /dev/null || \

...
## ntf_ct_4001001.sh --
##
##. 4001001	SMS	Notification Number	
##. 
##.    Verify: that sms notification works with Notification Number.
##. 
##.    Action: Send a message that will get a sms notification to a users
##.    notification number.
##. 
##.    Result: The sms notification will show in the smsc, displaying the
##.    correct content (according to .phr file used) and has been sent to
##.    the correct number."
##
## Syntax;
##
##  ntf_ct_4001001.sh cfg-file
##
## Description;
##

...
## ntf_ct_4002002.sh --
##
##. 4002002	Flash sms	Delivery profile
##. 
##.    Verify that Flash SMS notification works with delivery profiles.
##. 
##.    Action: Send a message that will get an Flash SMS notification to a
##.    user that have a delivery profile set.
##. 
##.    Result: The Flash SMS notification will be delivered to the
##.    notification number set in the correct delivery profile used.
##
## Syntax;
##
##  ntf_ct_4002002.sh cfg-file
##
## Description;
##
...
$toolsd/setuserattr $cfg emDeliveryProfile '442233;FLS;m'
...
grep "^To: 1,1,442233" $smslog > /dev/null || die "Invalid To: field"

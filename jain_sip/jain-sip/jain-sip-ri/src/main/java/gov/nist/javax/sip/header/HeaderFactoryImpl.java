...
public class HeaderFactoryImpl implements HeaderFactory {
	...
	*/
    ...
    /**
     * Create an empty History-Info header (RFC4244)
     * @return the created header
     */
    public HistoryInfoHeader createHistoryInfoHeader() {
    ...
    /**
     * Create a P-Charging-Vector header (RFC3455)
     * @param icid - ICID value
     * @return the created header
     */
    public PChargingVectorHeader createPChargingVectorHeader(String icid)
            throws ParseException {

        PChargingVectorHeader pChargingVectorHeader =
                new PChargingVector();
        pChargingVectorHeader.setICID(icid);

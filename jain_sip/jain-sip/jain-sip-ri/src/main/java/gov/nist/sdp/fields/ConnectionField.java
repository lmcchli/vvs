...
*
*/
public class ConnectionField extends SDPField implements com.mobeon.sdp.Connection {
	...
	*/
    ...
    /** Returns the TTL for the address of this Connection.
     * @return the TTL. -1 is returned if the TTL was not set.
     * @throws SdpParseException
     */
    public int getAddressTtl() throws SdpParseException {
        ...
        if (connectionAddress == null)
            ...
            return connectionAddress.getTtl();
    }

    /** Returns the number of addresses of this Connection.
     * @return the number of addresses. 1 is returned if the count was not set.
     * @throws SdpParseException
     */
    public int getAddressCount() throws SdpParseException {
        ...
        if (connectionAddress == null)
            ...
            return connectionAddress.getPort();
    }
     ...
     * @param ttl to set. Must be within 0-255.
     * @throws SdpException if the TTL is not within 0-255
     */
    public void setAddressTtl(int ttl) throws SdpException {
        if ((ttl < 0) || (ttl > 255))
            throw new SdpException("ttl should be between 0-255");
        else {
            if (address == null)
                address = new ConnectionAddress();
            address.setTtl(ttl);
    ...
    /** Sets the number of addresses for this Connection.
     * @param count to set. Must be > 0.
     * @throws SdpException if the number of addresses is < 1.
     */
    public void setAddressCount(int count) throws SdpException {
        if (count < 1)
            throw new SdpException("address count should be larger than 0");
        else {
            if (address == null)
                address = new ConnectionAddress();
            address.setPort(count);
            setAddress(address);
        }
    }

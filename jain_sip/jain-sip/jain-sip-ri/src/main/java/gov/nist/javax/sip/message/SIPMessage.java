...
public abstract class SIPMessage extends MessageObject implements
	 ...
	 * <p>
	 * EMALNYF: Removed support for character sets of body since this should be done
	 * 			per body part. Preferably supported by introducing parsing of 
	 * 			body parts in this class!
	 * 
	 ...
	 * <p>
	 * EMALNYF: NOTE the support for charset of message body has been removed
	 * 			since it should be done per body part. Preferably supported 
	 * 			by introducing parsing of body parts in this class.
	 * 
	...
	public byte[] getRawContent() {
		if (this.messageContent == null && this.messageContentBytes == null
			...
			return this.messageContentObject.toString().getBytes();
		} else if (this.messageContent != null) {
			return this.messageContent.getBytes();
		} else {
	...
	public void setContent(Object content, ContentTypeHeader contentTypeHeader)
		...
		if (content instanceof String) {
			...
			this.messageContentBytes = ((String) content).getBytes();

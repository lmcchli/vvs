 ...
 *
 *     For example, if a session is active at 10am on Monday and 11am on
 *     Tuesday for one hour each week for three months, then the <start time>
 *     in the corresponding "t=" field would be the NTP representation of 10am
 *     on the first Monday, the <repeat interval> would be 1 week, the
 *     <active duration> would be 1 hour, and the offsets would be zero and 25
 ...
 *     The unit indicates an appropriate multiplier for the integer.
 *

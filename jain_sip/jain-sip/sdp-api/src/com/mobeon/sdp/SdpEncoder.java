...
public interface SdpEncoder {
     ...
     * encoding is used. If a more compact representation
     ...
     * format strings. This is recommended but makes messages bigger.
     * The default is not to write such attributes.
     * @param flag  if true "a=rtpmap:" attributes are generated for all
     *          "RTP/AVP" formats
     */    
    public void setRtpmapAttribute(boolean flag);

    /**
     * Write the specified SessionDescription to the output stream using the
     * current settings.

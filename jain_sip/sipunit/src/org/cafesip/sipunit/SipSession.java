...
public class SipSession implements SipListener, SipActionObject
{
    ...
    protected static boolean destMatch(SipURI uri1, SipURI uri2)
    {
        if (uri1.getScheme().equalsIgnoreCase(uri2.getScheme()))
        {
            ...
            try {
                String host1 = InetAddress.getByName(uri1.getHost()).getHostAddress();
                String host2 = InetAddress.getByName(uri2.getHost()).getHostAddress();
            ...
            ArrayList additionalHeaders, ArrayList replaceHeaders, String body)
    {
        ...
        try
        {
            ...
            // mmany: I have removed clearing the branch below, since it will make
            // matching of for example CANCEL requests not working.

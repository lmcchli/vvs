...
public class SipTransaction
{
    ...
    /**
     * The user test program MAY call this method to view the
     * javax.sip.Dialog object this transaction belongs to. However,
     * knowledge of JAIN SIP API is required to interpret the Dialog object.
     * 
     * @return Returns the javax.sip.message.Dialog object that this

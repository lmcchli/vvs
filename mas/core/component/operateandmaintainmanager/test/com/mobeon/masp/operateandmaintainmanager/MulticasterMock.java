...
/**
    ...
    MulticasterMock object can reference two Subscriber objects, one or both
    ...
    MulticasterMock. The order in which Subscribers are notified is undefined.
...
public class MulticasterMock implements IEventReceiver
{
    protected final IEventReceiver a, b;

    protected MulticasterMock(IEventReceiver a, IEventReceiver b)
    {   this.a = a;
        this.b = b;
    }
    ...
    /**
       ...
       subscription_list = MulticasterMock.add( subscription_list, new_node );
       ...
       subscription_list = MulticasterMock.add( new_node, subscription_list );
    ...
    */
    ...
    {   return  (a == null)  ? b :
                (b == null)  ? a : new com.mobeon.masp.operateandmaintainmanager.MulticasterMock(a, b);
    }
    ...
    */
    public static IEventReceiver remove(IEventReceiver list, IEventReceiver remove_me)
    {
        if( list == remove_me || list == null  )
            return null;
        else if( !(list instanceof com.mobeon.masp.operateandmaintainmanager.MulticasterMock) )
            return list;
        else
            return ((com.mobeon.masp.operateandmaintainmanager.MulticasterMock)list).remove( remove_me );
    }
    ...
    public ArrayList<IEventReceiver> getReceiverArray() {
        ...
        if (a instanceof com.mobeon.masp.operateandmaintainmanager.MulticasterMock) {
            com.mobeon.masp.operateandmaintainmanager.MulticasterMock multicaster = (com.mobeon.masp.operateandmaintainmanager.MulticasterMock) a;
            ret = multicaster.getReceiverArray();
        }
        if (b instanceof com.mobeon.masp.operateandmaintainmanager.MulticasterMock) {
            com.mobeon.masp.operateandmaintainmanager.MulticasterMock multicaster = (com.mobeon.masp.operateandmaintainmanager.MulticasterMock) b;
            if (ret == null)
                ret = multicaster.getReceiverArray();
            else

...
public class RemoteFrom extends MirrorBase {
    Map<String, Object> hash = new HashMap<String, Object>();
    private final Connection connection;

    private Callable<Object> number = new Callable<Object>() {
        public Object call() {
            CallingParty callingParty = connection.getCall().getCallingParty().getFromCallingParty();
    ...
    public RemoteFrom(Connection connection) {
    ...
    public Object jstoString() {
        try {
            CallingParty party = connection.getCall().getCallingParty().getFromCallingParty();

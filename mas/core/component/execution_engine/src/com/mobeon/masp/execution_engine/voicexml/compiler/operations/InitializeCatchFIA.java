 ...
 */
public class InitializeCatchFIA extends VXMLOperationBase {
    private static final ILogger logger = ILoggerFactory.getILogger(InitializeCatchFIA.class);
    ...
    public void execute(VXMLExecutionContext ex) throws InterruptedException {
        ...
        Product catches = fiaObjects.getCatches();

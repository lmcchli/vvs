 ...
 */
public class Choice extends NodeCompilerBase {
    static ILogger logger = ILoggerFactory.getILogger(Choice.class);
    ...
    public Product compile(Module module, Compiler.CompilerPass compilerPass, Product parent, CompilerElement element, List<Node> content) {
        if (logger.isDebugEnabled()) logger.debug("Compiling Choice");

...
protected:
    ...
    static uint32_t BUFFER_SIZE_ARRAY[];
     ...
     * @param swap Wheter bytes should be swapped due to little/big endian differences.
     */ 
    virtual MediaObjectReader* createReader(JNIEnv* env, java::MediaObject* mo, bool swap);

...
MovAudioChunkContainerTest::testRechunkalize()
{
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Number of chunks should be equal",
                                 (unsigned)nOfChunks, (unsigned)audioChunksDefault.size());
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Number of chunks should be equal",
                                 (unsigned)nOfChunks, (unsigned)audioChunksCustom.size());
...
MovAudioChunkContainerTest::testGetNextRechunked()
{
    ...
    for (int chunkIndex(0); chunkIndex < audioChunksCustom.nOfRechunked(); chunkIndex++) {

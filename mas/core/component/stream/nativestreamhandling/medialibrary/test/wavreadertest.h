...
protected:
     ...
     * @param swap Whether bytes should be swapped due to little/big endian differences.
     */ 
    virtual WavReader* createReader(JNIEnv* env, java::MediaObject* mo, bool swap);
    /**

...
static void
findusername(ost::String &username);
...
void 
SDESItemsHolder::setItem(SDESItemType item, const ost::String& val)
{
...
Participant::Participant(const ost::String& cname) : SDESItemsHolder()
{
...
RTPApplication::RTPApplication(const ost::String& cname) :
		SDESItemsHolder(),
...
const Participant*
RTPApplication::getParticipant(const ost::String& cname) const
{

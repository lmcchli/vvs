...
public:
	...
	inline const ost::String& 
	getPRIVPrefix() const
	{ return sdesItems[SDESItemTypeEND]; }

	void
	setItem(SDESItemType item, const ost::String& val);
	
	inline void
	setPRIVPrefix(const ost::String& val)
...
private:
	...
	ost::String sdesItems[SDESItemTypeLast + 1];
};
...
public:
	 ...
	 **/
	Participant(const ost::String& cname);
...
private:
	 ...
	 **/
	inline void
	setSDESItem(SDESItemType item, const ost::String& val)
...
public:
	 ...
	 **/
	RTPApplication(const ost::String& cname);
	...
	const Participant*
	getParticipant(const ost::String& cname) const;

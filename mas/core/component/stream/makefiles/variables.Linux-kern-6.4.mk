...
JAVA_HOME ?= /app/vbuild/SLED12-x86_64/openjdk/17.0.2
...
LIBS=quicktime pthread stdc++ rt
INCLUDES = $(addprefix -I,$(INCDIRS))
LIBRARIES+= $(addprefix -L,$(LIBDIRS))
LIBRARIES+= -l:libnsl.so.2.0.0 
...
SYSLIBS += /usr/lib64/libstdc++.so.6

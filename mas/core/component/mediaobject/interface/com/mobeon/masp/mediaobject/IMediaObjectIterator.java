...
public interface IMediaObjectIterator {
     ...
     *
     * @exception java.util.NoSuchElementException If iteration has no more elements.
     * @exception MediaObjectException             If the operation fails, i.e. error occurrs when

...
public class FolderMock extends Folder {
    ...
    public void notifyFolderListeners(int i) {
        super.notifyFolderListeners(i);
    }

    public void notifyFolderRenamedListeners(Folder folder) {
        super.notifyFolderRenamedListeners(folder);
    }

    public void notifyMessageAddedListeners(Message[] messages) {
        super.notifyMessageAddedListeners(messages);
    }
    ...
    public void notifyMessageRemovedListeners(boolean b, Message[] messages) {
        super.notifyMessageRemovedListeners(b, messages);
    }
}

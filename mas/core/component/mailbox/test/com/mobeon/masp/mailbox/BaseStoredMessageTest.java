 ...
 * @author qhast
 */
public class BaseStoredMessageTest extends BaseMailboxTestCase
{
    BaseStoredMessage message;
    ...
    public BaseStoredMessageTest(String name)
    {
        super(name);
    }
    ...
    public void setUp() throws Exception
    {
        ...
        message = new BaseStoredMessage<BaseContext>(context);
    ...
    /**
     * Tests that constructor not initializes state.
     * @throws Exception
     */
    public void testGetSetState() throws Exception
    {
        assertNull("State should be null!",message.getState());
        message.setState(StoredMessageState.READ);
        assertEquals("State should be "+StoredMessageState.READ,StoredMessageState.READ,message.getState());
    }

    /**
     * Tests that constructor not initializes received date.
     * @throws Exception
     */
    public void testGetReceivedDate() throws Exception
    {
        assertNull("ReceivedDate should be null!",message.getReceivedDate());
    }

    /**
     * Tests that constructor initializes forward indicator to false.
     * @throws Exception
     */
    public void testIsForward() throws Exception
    {
        assertFalse("Forward indicator should be false!",message.isForward());
    }


    /**
     * Tests that constructor not initializes DeliveryReport.
     * @throws Exception
     */
    public void testGetDeliveryReport() throws Exception
    {
        assertNull("DeliveryReport should be null!",message.getDeliveryReport());
    }


    /**
     * Tests that constructor initializes delivery report indicator to false.
     * @throws Exception
     */
    public void testIsDeliveryReport() throws Exception
    {
        assertFalse("Delivery report should be false!",message.isDeliveryReport());
    }
    ...
    {
        return new TestSuite(BaseStoredMessageTest.class);
    }
}

...
import static com.mobeon.masp.mediaobject.MediaLength.LengthUnit.PAGES;
...
import com.abcxyz.messaging.common.message.*;
 ...
 * @author ecyncot
 */
public class MfsPartAdapter implements IMessageContent {

    private static final ILogger LOGGER = ILoggerFactory.getILogger(MfsPartAdapter.class);

    private MimePart part;
    private MfsContext context;
    private MediaProperties mediaProperties;
    private MessageContentProperties contentProperties;
    private IMediaObject mediaObject;

    protected MfsPartAdapter(MsgBodyPart part, MfsContext context) {

    	try {
			this.part = ContentFormatUtil.buildMimeBodyPart(part);
    ...
    protected MfsPartAdapter(MfsContext context) {
        this.context = context;
    }
...
//                    ));
            mediaProperties.setSize(part.getSize());

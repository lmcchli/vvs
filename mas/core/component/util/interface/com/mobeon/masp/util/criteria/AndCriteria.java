 ...
 * @see NotCriteria
 */
public abstract class AndCriteria<V extends CriteriaVisitor> extends Criteria<V> {

    /**
     * Conjunctioned criterias.
     */
     ...
     */
    public AndCriteria(Criteria<V>... criterias) {
        if(criterias.length < 2) {
            throw new IllegalArgumentException("You must provide at least two criterias to the AND criteria!");
        }
        ...
        for (int i=0; i<this.criterias.length; i++) {
            ...
            if(criteria == null) {
                throw new IllegalArgumentException("You must provide a non-null criterias to the AND criteria!");
            }
    ...
    /**
     * Gets the conjunctioned criterias.
     *
     * @return conjunctioned criterias.
     */
    ...
    public boolean equals(Object obj) {
        if (obj != null && obj.getClass().equals(this.getClass())) {
            AndCriteria other = (AndCriteria) obj;

...
{
    private static final String TESTDATA_BLOCK1 = "A587 OK Completed"+System.getProperty("line.separator");
    ...
    public void testWritingToStream() throws Exception
    {
       ...
       assertEquals(
                JavamailDebugOutputStream.MESSAGE_HEADER+TESTDATA_BLOCK1+
                JavamailDebugOutputStream.MESSAGE_HEADER+TESTDATA_BLOCK1
                ,buffer.toString());

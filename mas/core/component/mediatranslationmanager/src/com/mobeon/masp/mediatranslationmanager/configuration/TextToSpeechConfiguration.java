...
/**
 * This is a placeholder for the MRCP TTS configuration parameters.
 */
public class TextToSpeechConfiguration extends AbstractConfiguration {
    private IServiceInstance service = null;

    public TextToSpeechConfiguration(IServiceInstance service) {

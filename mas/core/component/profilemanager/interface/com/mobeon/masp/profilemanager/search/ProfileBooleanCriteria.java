 ...
 * @version 1.0
 */
public class ProfileBooleanCriteria extends ValueCriteria<Boolean, ProfileCriteriaVisitor> {
     ...
     * @param value
     */
    public ProfileBooleanCriteria(String name, boolean value) {
        super(name, value);
    }
    ...
    public void accept(ProfileCriteriaVisitor visitor) {
        visitor.visitProfileBooleanCriteria(this);
    }
     ...
     */
    public ProfileBooleanCriteria clone() {
        return new ProfileBooleanCriteria(getName(), getValue());
    }
}

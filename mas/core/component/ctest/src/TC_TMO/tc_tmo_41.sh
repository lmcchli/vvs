...
test_description="Verify that MAS will handle the Diversion header correctly when the Privacy header is set to \"session\" in the request but there is no privacy set in the Diversion header"
test_id="41"

...
test_description="Verify that MAS will handle both ANI and RDNIS as private/restricted if ANI is presented in the P-Asserted-Identity header and privacy value is set to \"session\""
test_id="31"

...
test_description="PlatformAccess - systemSendAccountRequest - error handling"
test_id="20006010"
...
function test_func {
	...
	# Configure MAS to use an faulty airnode.
	replace-mas-chargingaccountmanager-conf-param host 1\.1\.1\.1
	...
	make-sipp-call $prefix_dir/$test_id.xml $num $num
#	if [ $? -ne 0 ]; then return 1; fi
	...
	restore-mas-chargingaccountmanager-conf

test_description="UCIP - Refill testcase-collection"
test_id="555"
function test_func {
...
test_id="20016022"
while [  $test_id -lt 20016023 ]; do
  
  if [ $test_id = "20016022" ]; then
  	test_description="UCIP - Refill - voucherActivationCode"
  else

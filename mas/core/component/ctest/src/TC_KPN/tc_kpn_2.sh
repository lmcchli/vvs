...
test_description="Verify that MAS will send the 183 message as a reliable response if early media is used by the service application and the invite includes a supported header with 100rel and sendprovisionalresponsesreliable is set to \"sdponly\""
test_id="2"

...
test_description="Verify that MAS will send the 180 message as a non-reliable response if early media is not used by the service application and the invite includes a supported header with 100rel and sendprovisionalresponsesreliable is set to \"no\""
test_id="24"

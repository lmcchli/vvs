...
test_description="Verify that MAS will send the 183 message as a non-reliable response if early media is used by the service application and the invite includes a supported header with 100rel and sendprovisionalresponesreliable is set to \"no\""
test_id="8"

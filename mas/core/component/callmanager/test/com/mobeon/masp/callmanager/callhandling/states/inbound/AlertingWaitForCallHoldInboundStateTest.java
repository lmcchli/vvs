...
/**
 * AlertingWaitForCallHoldInboundState Tester.
 *
 * @author Malin Nyfeldt
 */
public class AlertingWaitForCallHoldInboundStateTest extends InboundStateCase {

    AlertingWaitForCallHoldInboundState alertingWaitForCallHoldState;

    protected void setUp() throws Exception {
        super.setUp();

        alertingWaitForCallHoldState = new AlertingWaitForCallHoldInboundState(
    ...
    public void testLock() throws Exception
    {
        ...
        alertingWaitForCallHoldState.processLockRequest();
    }
    ...
    public void testPlay() throws Exception {
        ...
        alertingWaitForCallHoldState.play(playEvent);
    }
    ...
    public void testRecord() throws Exception {
        ...
        alertingWaitForCallHoldState.record(recordEvent);
    }
    ...
    public void testStopPlay() throws Exception {
        ...
        alertingWaitForCallHoldState.stopPlay(stopPlayEvent);
    }
    ...
    public void testStopRecord() throws Exception {
        mockInboundCall.expects(never());
        alertingWaitForCallHoldState.stopRecord(stopRecordEvent);
    }
    ...
    public void testProcessVideoFastUpdateRequest() throws Exception {
        mockInboundCall.expects(never());
        alertingWaitForCallHoldState.processVideoFastUpdateRequest();
    }
    ...
    public void testAccept() throws Exception
    {
        assertNotAllowedEvent(mockInboundCall,
                "Accept is not allowed in Alerting state (sub state WaitForCallHold).");
        alertingWaitForCallHoldState.accept(acceptEvent);
    }
    ...
    public void testNegotiateEarlyMediaTypes() throws Exception
    {
        assertNotAllowedEvent(mockInboundCall,
                ...
                "Alerting state (sub state WaitForCallHold).");
        alertingWaitForCallHoldState.negotiateEarlyMediaTypes(
    ...
    public void testReject() throws Exception
    {
        assertNotAllowedEvent(mockInboundCall,
                ...
                "(sub state WaitForCallHold).");
        alertingWaitForCallHoldState.reject(rejectEvent);
    }
    ...
    public void testDisconnect() throws Exception
    {
        ...
        assertCreateBye(false);
        assertSendRequestWithinDialog(false);
        alertingWaitForCallHoldState.disconnect(disconnectEvent);
    }
    ...
    public void testProcessAck() throws Exception
    {
        ...
        alertingWaitForCallHoldState.processAck(additionalSipRequestEvent);
    }
    ...
    public void testProcessBye() throws Exception
    {
        ...
        assertStreamsDeleted(mockInboundCall);
        alertingWaitForCallHoldState.processBye(additionalSipRequestEvent);
    }
    ...
    {
        assertOkResponseSent(mockInboundCall);
        alertingWaitForCallHoldState.processCancel(additionalSipRequestEvent);
    }
    ...
    {
        try {
            alertingWaitForCallHoldState.processInvite(initialSipRequestEvent);
    ...
    public void testProcessReInviteWithNoSdpOffer() throws Exception
    {
        ...
        alertingWaitForCallHoldState.processReInvite(additionalSipRequestEvent);
    }
    ...
    /**
     * Verifies reception of a SIP re-INVITE request.
     * If the re-INVITE contains an SDP that is NOT a call hold, 
     * a SIP 488 "Not Acceptable Here"
     * response is sent for the re-INVITE and that the state is left unchanged.
     *
     * @throws Exception if test case failed.
     */
    public void testProcessReInviteWhenNotCallHold() throws Exception
    {
        assertSdpInRequest(mockInboundCall, SUCCEED);
        assertParsingSdpBody(mockInboundCall, SUCCEED);
        assertCallHold(mockInboundCall, false);
        assertNotAcceptableResponseSent(
                mockInboundCall, SipWarning.RENEGOTIATION_NOT_SUPPORTED);
        alertingWaitForCallHoldState.processReInvite(additionalSipRequestEvent);
    }
    ...
    public void testProcessReInviteWhenNoSdpIntersectionFound() throws Exception
    {
        assertSdpInRequest(mockInboundCall, SUCCEED);
        assertParsingSdpBody(mockInboundCall, SUCCEED);
        assertCallHold(mockInboundCall, true);
    ...
    /**
     * Verifies reception of a SIP re-INVITE request.
     * If the re-INVITE contains a call hold SDP, a SIP 200 OK response is sent 
     * for the re-INVITE, the No ACK timer is started and the state is set to 
     * AlertingWaitForNewMedia.
     *
     * @throws Exception if test case failed.
     */
    public void testProcessReInvite() throws Exception
    {
        ...
        assertStateAlerting(AlertingInboundState.AlertingSubState.WAIT_FOR_NEW_MEDIA);
    ...
    {
        assertOkResponseSent(mockInboundCall);
        alertingWaitForCallHoldState.processOptions(additionalSipRequestEvent);
    }
    ...
    public void testProcessInfo() throws Exception
    {
        ...
        alertingWaitForCallHoldState.processInfo(additionalSipRequestEvent);
    }
    ...
    public void testProcessPrack() throws Exception
    {
        ...
        alertingWaitForCallHoldState.processPrack(additionalSipRequestEvent);
    }
    ...
    public void testProcessResponse() throws Exception
    {
        ...
        alertingWaitForCallHoldState.processSipResponse(sipResponseEvent);
    }
    ...
    public void testProcessTimeout() throws Exception
    {
        ...
        assertCreateBye(SUCCEED);
        assertSendRequestWithinDialog(SUCCEED);
        alertingWaitForCallHoldState.processSipTimeout(sipTimeoutEvent);
    }
    ...
    public void testHandleCallTimeout_CallNotAccepted() throws Exception {
        mockInboundCall.expects(never());
        alertingWaitForCallHoldState.handleCallTimeout(callNotAcceptedTimeoutEvent);
    }
    ...
    public void testHandleCallTimeout_NoAck() throws Exception {
        ...
        alertingWaitForCallHoldState.handleCallTimeout(noAckTimeoutEvent);
    }

    /**
     * Verifies that a Redirected RTP timeout results in an outbound stream
     * being created, a Connected event and the
    ...
    public void testHandleCallTimeout_RedirectedRtp() throws Exception {
        ...
        mockInboundCall.expects(once())
                .method("getSdpIntersection").will(returnValue(sdpIntersection));
        assertOutboundStreamCreated(mockInboundCall, SUCCEED);
        assertConnectedEvent(mockInboundCall);
        assertStateConnected();

        alertingWaitForCallHoldState.handleCallTimeout(redirectedRtpTimeoutEvent);
    }
    ...
    public void testHandleAbandonedStream() throws Exception {
        mockInboundCall.expects(never());
        alertingWaitForCallHoldState.handleAbandonedStream();
    }

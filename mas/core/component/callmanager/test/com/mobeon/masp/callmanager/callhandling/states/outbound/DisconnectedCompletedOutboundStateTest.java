...
/**
 * DisconnectedCompletedOutboundState Tester.
 *
 * @author Malin Flodin
 */
public class DisconnectedCompletedOutboundStateTest extends OutboundStateCase {
    DisconnectedCompletedOutboundState disconnectedCompletedState;

    protected void setUp() throws Exception {
        super.setUp();

        disconnectedCompletedState = new DisconnectedCompletedOutboundState(
    ...
    public void testDial() throws Exception {
        assertNotAllowedEvent(mockOutboundCall,
                "Dial is not allowed in Disconnected state " +
                        "(sub state Completed).");
        disconnectedCompletedState.dial(dialEvent);
    }
    ...
    public void testSendToken() throws Exception {
        assertNotAllowedEvent(mockOutboundCall,
                "SendToken is not allowed in Disconnected state " +
                        "(sub state Completed).");
        disconnectedCompletedState.sendToken(sendTokenEvent);
    }
    ...
    public void testHandleCallTimeout() throws Exception {
        mockOutboundCall.expects(never());
        disconnectedCompletedState.handleCallTimeout(maxCallDurationTimeoutEvent);
    }

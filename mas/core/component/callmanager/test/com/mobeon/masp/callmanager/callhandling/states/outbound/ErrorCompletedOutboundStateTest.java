...
/**
 * ErrorCompletedOutboundState Tester.
 *
 * @author Malin Flodin
 */
public class ErrorCompletedOutboundStateTest extends OutboundStateCase {
    ErrorCompletedOutboundState errorCompletedState;

    protected void setUp() throws Exception {
        super.setUp();

        errorCompletedState = new ErrorCompletedOutboundState(
    ...
    public void testDial() throws Exception {
        assertNotAllowedEvent(mockOutboundCall,
                "Dial is not allowed in Error state " +
                        "(sub state Completed).");
        errorCompletedState.dial(dialEvent);
    }
    ...
    public void testSendToken() throws Exception {
        assertNotAllowedEvent(mockOutboundCall,
                "SendToken is not allowed in Error state " +
                        "(sub state Completed).");
        errorCompletedState.sendToken(sendTokenEvent);
    }
    ...
    public void testHandleCallTimeout() throws Exception {
        mockOutboundCall.expects(never());
        errorCompletedState.handleCallTimeout(maxCallDurationTimeoutEvent);
    }

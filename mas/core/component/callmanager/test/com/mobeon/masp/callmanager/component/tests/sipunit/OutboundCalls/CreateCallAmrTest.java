...
/**
 * Call Manager component test case to verify creating outbound AMR calls.
 * @author Malin Flodin
 */
public class CreateCallAmrTest extends OutboundSipUnitCase {
	...
	super.callManagerConfigFile = CallManagerTestContants.CALLMANAGER_AMR_XML;
        ...
        videoBody =
            ...
            + "t=0 0\r\n"
            + "m=audio " + simulatedPhone.getRTPPort() + " RTP/AVP 98 101\r\n"
            + "b=AS:13\r\n"
	...
	voiceBody =
        ...
        outboundMediaTypes.addMimeType(new MimeType("audio/amr"));
    ...
    public void testNormalOutboundCallSetupWithSsp() throws Exception {
        ...
        RequestEvent requestEvent = assertCallCreated(simulatedPhone, false);
        ...
        simulatedSecondPhone.acceptCall(voiceBody);
    ...
    public void testNormalOutboundCallSetupWithoutSsp() throws Exception {
        ...
        // Phone sends ok
        simulatedPhone.acceptCall(voiceBody);

...
/**
 * Represents the sub state "LingeringBye" of {@link ErrorInboundState}.
 ...
 * @author Malin Flodin
 */
public class ErrorLingeringByeInboundState extends ErrorInboundState {

    private final ILogger log = ILoggerFactory.getILogger(getClass());

    public ErrorLingeringByeInboundState(InboundCallInternal call) {
        super(call);
    }

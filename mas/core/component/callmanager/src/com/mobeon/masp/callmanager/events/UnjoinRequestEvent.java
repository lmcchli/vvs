...
/**
 * This class is an event that carries all information regarding an unjoin
 * requested by the Call Manager client.
 * <p>
 * This class is immutable.
 * @author Malin Flodin
 */
public final class UnjoinRequestEvent implements EventObject {

    private final Call firstCall;
    private final Call secondCall;
    private final IEventDispatcher eventDispatcher;

    public UnjoinRequestEvent(Call firstCall, Call secondCall,

...
/**
 * Represents the sub state "LingeringBye" of {@link FailedOutboundState}.
 * This sub state is entered when an invalid OK response was received for the
 * initial INVITE in {@link ProgressingOutboundState}.
 ...
 * @author Malin Flodin
 */
public class FailedLingeringByeOutboundState extends FailedOutboundState {

    private final ILogger log = ILoggerFactory.getILogger(getClass());

    public FailedLingeringByeOutboundState(OutboundCallInternal call) {
        super(call);
    }
     ...
     * the state being set to {@link FailedCompletedOutboundState}.
     *

...
/**
 * An interface to provide access to the configuration manager instantiated by the IPlatformAccessConfigManagerFactory
 */
public interface IPlatformAccessConfigManager {

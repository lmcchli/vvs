...
public class MasStubLinuxTest //extends TestCase
{
    ...
    static public void setUp() throws Exception {
        ...
        String configFilename = "/opt/moip/common/backend.conf";
    ...
    {
        try {
            MasStubLinuxTest test= new MasStubLinuxTest();

            System.err.println("MasStubLinuxTest: setUp");
            test.setUp();
            
            System.err.println("MasStubLinuxTest: depositeMessage");
            test.depositeMessage();
            
            System.err.println("MasStubLinuxTest: tearDown");
            test.tearDown();
            
        }catch (java.lang.Throwable t) {
            System.err.println("MasStubLinuxTest: "+t.getMessage());
            t.printStackTrace();
        }
    }

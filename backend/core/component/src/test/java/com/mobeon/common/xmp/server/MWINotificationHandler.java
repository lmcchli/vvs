...
public class MWINotificationHandler implements ServiceHandler {
    private final String serviceName = "mwinotification";
    ServerConfig config;

    /** Creates a new instance of TestServiceHandler */
    public MWINotificationHandler() {
    ...
    public void handleRequest(XmpResponseQueue responseQueue,
        ...
        String number = getParameterValue("number", xmpDoc);
        System.out.println("Received MWIRequest for " + number);
     ...
     */
    public static ServiceHandler get() {
        return new MWINotificationHandler();
    }
}

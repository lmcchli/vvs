...
import com.mobeon.common.provisionmanager.cai.CAIException;
import com.mobeon.common.provisionmanager.cai.CreateCommand;
...
public class ProvisioningTest extends MockObjectTestCase {
    private static final String cfgFile = "test/com/mobeon/common/provisionmanager/provisionmanager.xml";
    private static final String LOG4J_CONFIGURATION = "test/com/mobeon/common/provisionmanager/log4jconf.xml";

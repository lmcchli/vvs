...
public class TimeoutRetrierTest extends MockObjectTestCase {
    ...
    public void testTimeout() throws Exception {
        ...
        ThreadPoolExecutor threadPoolExecutor = (ThreadPoolExecutor) ExecutorServiceManager.getInstance().getExecutorService("com.mobeon.common.util.executor.TimeoutRetrier");

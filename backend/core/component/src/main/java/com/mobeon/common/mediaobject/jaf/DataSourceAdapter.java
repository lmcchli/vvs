 ...
 */
package com.mobeon.common.mediaobject.jaf;

import com.mobeon.common.mediaobject.IMediaObject;
...
public class DataSourceAdapter implements DataSource {
     ...
     * The method delegates the call to {@link com.mobeon.common.mediaobject.MediaProperties#getContentType()}
     *
     ...
     * The method delegates the call to {@link com.mobeon.common.mediaobject.IMediaObject#getInputStream()}
     *

...
import com.mobeon.common.provisionmanager.cai.*;
import com.mobeon.common.util.executor.ExecutorServiceManager;
...
public class Provisioning implements IProvisioning, IEventReceiver {
    ...
    private void waitForAsyncCommand(int transactionid) throws ProvisioningException {
        ...
        try {
            ...
            log.error("Exception in waitForAsyncCommand " + e,e);
    ...
    private CAIConnectionPool createConnectionPool(String adminUid, String adminPwd) throws ProvisioningException {
        ...
        try {
            ...
            log.error("Exception in createConnectionPool, could not locate service " + IServiceName.PROVISIONING);
            throw new ProvisioningException(e);
        }
        catch (NumberFormatException e) {
        	e.printStackTrace(System.out);
        	log.error("Exception in createConnectionPool, port is not numeric ");
        	throw new ProvisioningException(e);
        }
    }
    ...
    private void updateConfiguration() {
        ...
        try {
            ...
            log.error("Exception in setupConfiguration " + e,e);
        }
    }
